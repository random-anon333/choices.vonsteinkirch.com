...
### <mark style="color:green;">Transits result from the</mark> [functions](../../../../computers/usd/ai-and-singularity/algorithms/functions.md) <mark style="color:green;">describing how the game's underlying</mark> [algorithms](../../../../computers/usd/ai-and-singularity/algorithms/) <mark style="color:green;">are designed, and consequently, they affect the collective</mark> [reality](../../../../reality/usd/reality-as-a-quantum-simulation.md) <mark style="color:green;">in the game of $CHOICES. In this sense, transits can be used to predict general outcomes from the underlying algorithm in the game of $CHOICES</mark>
